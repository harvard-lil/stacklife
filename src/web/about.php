...
<body>
    ...
    <div class="container group">
		...
		<div class="row group">
        	...
        	<ul>
        		<li>(a) When a user does not already have cached copy of jQuery (an open source library of Javascript functionality) on her or his machine, ShelfLife fetches a copy via the Google API.  This procedure slightly improves performance</li><br />
        		
        		<li>(b) Similar to (a), if the user does not already have cached copies of some fonts, ShelfLife automatically downloads them via the Google API.</li><br />
        		
        		<li>(c) ShelfLife uses Google Analytics, to provide information to the Library Innovation Lab about the number and patterns of people visiting ShelfLife. Google Analytics is in wide use around the Web. More information about what it tracks can be found <a href="http://www.google.com/analytics/">here</a>. If you would like to opt out of Google Analytics for all sites, please follow the instructions on <a href="http://tools.google.com/dlpage/gaoptout">this page.</a></li><br />
        		
        		<li>(d) Pages that contain embedded YouTube videos fetch the image of that video from YouTube. (YouTube is owned by Google)</li>
        	</ul>
